            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                Bagian untuk Mengedit produk item.
                            </div>
                        </div>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-1">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <label for="inputNama"> No </label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input class="form-control" type="text" name="no" readonly value="<?php echo $dat['no']; ?>" />      
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input class="form-control" type="text" name="nama" value="<?php echo $dat['nama']; ?>"/>      
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3 mb-md-0">
                                            ...
                                            <input class="form-control" type="text" name="deskripsi" value="<?php echo $dat['deskripsi']; ?>"/>
